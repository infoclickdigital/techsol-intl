...
export default function AdminPage() {
  ...
  const [contactIndustrialCenters, setContactIndustrialCenters] = useState('');
      ...
      if (res.ok) {
        ...
        if (payload.success) {
          ...
          const cmsDict: Record<string, string> = {
            ...
            about_mission: '',
            about_vision: '',
            home_industry_title_1: '',
            home_industry_desc_1: '',
            home_industry_title_2: '',
            home_industry_desc_2: '',
            home_industry_title_3: '',
            home_industry_desc_3: '',
          ...
          payload.config.forEach((item: CmsItem) => {
            ...
            if (item.key === 'social_facebook') setSocialFacebook(item.value);
            if (item.key === 'social_instagram') setSocialInstagram(item.value);
            if (item.key === 'social_linkedin') setSocialLinkedin(item.value);
            ...
            if (item.key === 'contact_industrial_centers') setContactIndustrialCenters(item.value);
            if (item.key === 'google_maps_embed_url') setGoogleMapsEmbedUrl(item.value);
          });
        }
      }
    } catch (err) {
  ...
  const saveSettingsChanges = async (e: React.FormEvent) => {
    ...
    try {
      const settingsItems = [
        ...
        { key: 'contact_industrial_centers', value: contactIndustrialCenters.trim() },
        { key: 'google_maps_embed_url', value: googleMapsEmbedUrl.trim() },
      ];
          ...
          <form onSubmit={saveCmsChanges} className="bg-white border border-slate-200 p-6 sm:p-8 space-y-8 shadow-xs animate-fade-in">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-mono uppercase text-slate-400 font-bold block">
                    Scrolling Partner Trust Strip Text / Marquee
                  </label>
                  <input
                    type="text"
                    required
                    value={cmsFormMapping['trust_strip_text'] || ''}
                    onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, trust_strip_text: e.target.value })}
                    className="w-full border border-slate-200 focus:border-amber-600 outline-none px-4 py-3 text-xs sm:text-sm font-sans rounded-none"
            ...
            <div className="space-y-6 pt-6 border-t border-slate-100">
              <h3 className="text-xs font-bold uppercase tracking-widest text-slate-900 border-b pb-2 font-mono flex items-center gap-2">
                <Sliders className="h-4.5 w-4.5 text-amber-600" />
                <span>Industries We Serve Across Nepal (Homepage - 4 Sections)</span>
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Section 1 */}
                <div className="bg-slate-50 p-4 border border-slate-200 space-y-3">
                  <span className="text-[10px] font-mono font-bold text-amber-600">SECTION 01</span>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono uppercase text-slate-400 block font-bold">Heading</label>
                    <input
                      type="text"
                      required
                      value={cmsFormMapping['home_industry_title_1'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_title_1: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none font-sans"
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono uppercase text-slate-400 block font-bold">Small Description</label>
                    <textarea
                      rows={2}
                      required
                      value={cmsFormMapping['home_industry_desc_1'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_desc_1: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none resize-none leading-relaxed font-sans"
                    />
                  </div>
                </div>
                ...
                {/* Section 2 */}
                <div className="bg-slate-50 p-4 border border-slate-200 space-y-3">
                  <span className="text-[10px] font-mono font-bold text-amber-600">SECTION 02</span>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono uppercase text-slate-400 block font-bold">Heading</label>
                    <input
                      type="text"
                      required
                      value={cmsFormMapping['home_industry_title_2'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_title_2: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none font-sans"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <textarea
                      rows={2}
                      required
                      value={cmsFormMapping['home_industry_desc_2'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_desc_2: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none resize-none leading-relaxed font-sans"
                    />
                  </div>
                </div>
                ...
                {/* Section 3 */}
                <div className="bg-slate-50 p-4 border border-slate-200 space-y-3">
                  <span className="text-[10px] font-mono font-bold text-amber-600">SECTION 03</span>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono uppercase text-slate-400 block font-bold">Heading</label>
                    <input
                      type="text"
                      required
                      value={cmsFormMapping['home_industry_title_3'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_title_3: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none font-sans"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <textarea
                      rows={2}
                      required
                      value={cmsFormMapping['home_industry_desc_3'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_desc_3: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none resize-none leading-relaxed font-sans"
                    />
                  </div>
                </div>
                ...
                {/* Section 4 */}
                <div className="bg-slate-50 p-4 border border-slate-200 space-y-3">
                  <span className="text-[10px] font-mono font-bold text-amber-600">SECTION 04</span>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono uppercase text-slate-400 block font-bold">Heading</label>
                    <input
                      type="text"
                      required
                      value={cmsFormMapping['home_industry_title_4'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_title_4: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none font-sans"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <textarea
                      rows={2}
                      required
                      value={cmsFormMapping['home_industry_desc_4'] || ''}
                      onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, home_industry_desc_4: e.target.value })}
                      className="w-full border border-slate-200 bg-white focus:border-amber-600 px-3 py-2 text-xs outline-none resize-none leading-relaxed font-sans"
                    />
                  </div>
                </div>
            ...
            {/* ABOUT US ADDITIONAL CUSTOM SECTIONS */}
            <div className="space-y-6 pt-6 border-t border-slate-100">
              <h3 className="text-xs font-bold uppercase tracking-widest text-slate-900 border-b pb-2 font-mono flex items-center gap-2">
                <Sliders className="h-4.5 w-4.5 text-amber-600" />
                <span>Interior About us Page Custom Sections</span>
              </h3>

              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-mono uppercase text-slate-400 font-bold block">
                    Operational Framework Description
                  </label>
                  <textarea
                    rows={2}
                    required
                    value={cmsFormMapping['about_operational_framework'] || ''}
                    onChange={(e) => setCmsFormMapping({ ...cmsFormMapping, about_operational_framework: e.target.value })}
              ...
              <form onSubmit={saveSettingsChanges} className="space-y-6">
                <div className="space-y-4 font-normal">
                  ...
                  <div className="border-t border-slate-150 pt-5 mt-5 space-y-4">
                    <span className="text-[11px] font-mono font-bold uppercase text-amber-600 block tracking-wider">
                      Footer & Contact information replication
                    </span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          placeholder="e.g. Tinkune-32, Kathmandu, Nepal"
                          className="w-full border border-slate-200 focus:border-amber-600 px-4 py-3 text-xs rounded-none outline-none font-mono"
                        />
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          placeholder="e.g. +977-1-4491100, +977-9851023450"
                          className="w-full border border-slate-200 focus:border-amber-600 px-4 py-3 text-xs rounded-none outline-none font-mono"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <label className="text-[10px] font-mono font-bold uppercase text-slate-400 block">
                          Contact Official Email Address
                        </label>
                        <input
                          type="email"
                          required
                          ...
                          placeholder="e.g. info@techsol.international"
                          className="w-full border border-slate-200 focus:border-amber-600 px-4 py-3 text-xs rounded-none outline-none font-mono"
                        />
                      </div>
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-mono font-bold uppercase text-slate-400 block">
                          Industrial Centers across Nepal
                        </label>
                        <input
                          type="text"
                          required
                          value={contactIndustrialCenters}
                          onChange={(e) => setContactIndustrialCenters(e.target.value)}
                          placeholder="e.g. Tinkune (Kathmandu) & Mills Parkway (Biratnagar, Bhairahawa)"
                          className="w-full border border-slate-200 focus:border-amber-600 px-4 py-3 text-xs rounded-none outline-none font-mono"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-1 font-normal font-mono">
                        <label className="text-[10px] font-mono font-bold uppercase text-slate-400 block">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full border border-slate-200 focus:border-amber-600 px-4 py-3 text-xs rounded-none outline-none font-mono"
                      />
                      <span className="text-[9px] text-slate-400 font-mono block">Provide the Google Maps iframe src URL to display on the contact page.</span>
                    </div>
                  </div>
