...
export default function Logo({ className = '', size = 'md' }: LogoProps) {
  ...
  // We render the beautiful, crisp vector SVG representing the Techsol International logo directly.
  // This guarantees that the logo is always displayed flawlessly, crisp on all DPIs, with zero layout shift or broken link icons.
  return (
    <div 
      className={`flex items-center select-none ${className}`} 
      id="techsol-logo-wrapper"
      style={{ height: dim.h, width: dim.w }}
    >
      <svg
        width="100%"
        height="100%"
      ...
      >
        ...
        {/* ======================================================== */}
        {/* TECH (Corporate Blue - #0B5296) */}
        {/* ======================================================== */}
        {/* Letter T */}
        <path d="M 15 20 H 51 V 31 H 39 V 80 H 27 V 31 H 15 Z" fill="#0B5296" />

        {/* Letter E */}
        <path d="M 62 20 H 96 V 31 H 74 V 45 H 93 V 55 H 74 V 69 H 96 V 80 H 62 Z" fill="#0B5296" />

        {/* Letter C */}
        <path d="M 144 20 H 112 A 10 10 0 0 0 102 30 V 70 A 10 10 0 0 0 112 80 H 144 V 69 H 114 V 31 H 144 Z" fill="#0B5296" />

        {/* Letter H */}
        <path d="M 152 20 H 164 V 45 H 178 V 20 H 190 V 80 H 178 V 56 H 164 V 80 H 152 Z" fill="#0B5296" />

        {/* ======================================================== */}
        {/* SOL (Vibrant Industrial Orange - #E05A10) */}
        {/* ======================================================== */}
        {/* Letter S */}
        <path d="M 234 34 H 222 C 222 27 218 23 212 23 C 206 23 202 26 202 30 C 202 36 210 38 218 40 C 228 43 236 46 236 56 C 236 66 226 77 212 77 C 198 77 192 70 192 62 H 204 C 204 67 208 70 214 70 C 220 70 224 67 224 63 C 224 58 218 56 210 54 C 200 51 192 47 192 38 C 192 28 201 20 214 20 C 227 20 234 28 234 34 Z" fill="#E05A10" />

        {/* Letter O with Dynamic Embedded Cogwheel Gear */}
        <g mask="url(#logo-swoosh-mask-v2)">
          <g transform="translate(292, 50)">
            {/* Gear hub/rim */}
            <circle cx="0" cy="0" r="11" fill="none" stroke="#E05A10" strokeWidth="4.5" />
            <circle cx="0" cy="0" r="22.5" stroke="#E05A10" strokeWidth="5" fill="none" />
            {/* 12 gear teeth */}
            <g fill="#E05A10">
        ...
        {/* Top crescent swoosh */}
        <path d="M 235 40 C 270 24 308 24 345 35 C 308 28 270 29 235 40 Z" fill="#E05A10" />
        {/* Middle crescent swoosh */}
        <path d="M 230 54 C 270 44 308 44 345 53 C 308 48 270 49 230 54 Z" fill="#E05A10" />
        {/* Bottom crescent swoosh */}
        <path d="M 233 68 C 270 65 308 66 342 77 C 308 72 270 71 233 68 Z" fill="#E05A10" />

        {/* Letter L */}
        <path d="M 348 20 H 360 V 69 H 382 V 80 H 348 Z" fill="#E05A10" />
        ...
        <text
          ...
          style={{ letterSpacing: '0.45em', textTransform: 'lowercase' }}
        >
          international
        </text>
      </svg>
